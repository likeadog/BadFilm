package com.zhuang.badfilm.update;
...
public class UpdateManager {
    ...
    private String uri = "https://www.liguanjian.com/update/app-release.apk";
    ...
    void compareLoadVersion(int remoteVersion,String log) {
        long downloadId = SharedPreferencesUtil.getDownloadId();
        if (downloadId != -1) {
    ...
    public void startDownload() {
        ...
        //req.setDestinationInExternalFilesDir(applicationContext, Environment.DIRECTORY_DOWNLOADS, "badFilm.apk");
        req.setDestinationInExternalPublicDir("BadFilmApk", "badFilm.apk");
        long newDownloadId = downloadManager.enqueue(req);
        //把DownloadId保存到本地
        SharedPreferencesUtil.setDownloadId(newDownloadId);
    }
    ...
    void loadApkVersion() {
        ApkService apkService = RetrofitHelper.createService(ApkService.class);
